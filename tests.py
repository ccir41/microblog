...
class UserModelCase(unittest.TestCase):
    ...
    def test_password_hashing(self):
        ...
        self.assertFalse(u.check_password('flask'))
        self.assertTrue(u.check_password('testing'))

    def test_avatar(self):
        u = User(username='shishir41', email='shishirsubedi41@gmail.com')
        self.assertEqual(u.avatar(128), ('https://www.gravatar.com/avatar/'
                                         '13f4a5bd400c5b71407868dc4fe4f752'
                                         '?d=identicon&s=128'))
